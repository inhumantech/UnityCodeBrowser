...
public class CodeBrowser : EditorWindow {
    ...
    //====================================================================================================//
    /*void CreateEXE(){
        var assembly = AssemblyDefinition.CreateAssembly(new AssemblyNameDefinition("HelloWorld", new Version()), "HelloWorld", ModuleKind.Console);
        ...
        var program = new TypeDefinition("HelloWorld", "Program", Mono.Cecil.TypeAttributes.Class | Mono.Cecil.TypeAttributes.Public, module.ImportReference(typeof(object)));
        ...
        assembly.Write(@"c:\Spark\HelloWorld.exe");
    }*/
